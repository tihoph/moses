...
def get_parser(
    ...
    model_arg.add_argument("--latent_size", type=int, default=128, help="Size of latent vectors")
    model_arg.add_argument(
    ...
    train_arg.add_argument("--weight_decay", type=int, default=0, help="weight decay for optimizer")
